...
<body>
    ...
    <main>
        ...
        <article class="index">
            <h2>About Us</h2>
            <p><span class="hightlight">Sunny Spot Holidays</span> is owned by Jack Jones and offers a perfect getaway
                ...
                At <span class="hightlight">Sunny Spot Holidays</span>, we focus on comfort, relaxation, and a warm,
            ...
            <div class="strengths">
                <div class="nature">
                    <img src="images/nature-icon.png" alt="nature icon">
                    <p>Immerse Yourself in Nature</p>
                </div>
                <div class="cozy-living">
                    <img src="images/wooden-house-icon.png" alt="wooden house icon">
