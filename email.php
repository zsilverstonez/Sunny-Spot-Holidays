...
";
            ...
            $mail->send();
            $message = "Password reset code sent to $email.<br>Please check your email.";
        } catch (Exception $e) {
            $message = "Mailer Error. Please try again.";
        }
        $message = "A password reset link has been sent to your email.<br>Please check your inbox to reset your password.";
        // log error message in cPanel
