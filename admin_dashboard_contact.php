...
<head>
    ...
    <title>Sunny Spot Holidays - Admin Dashboard - Contact</title>
    ...
    <header>
        ...
        <nav>
            <ul>
                ...
                <li class="nav-contact"><a href="admin_dashboard_contact.php" class="active">Contact</a></li>
            ...
            <form method="GET" action="" class="filter-form">
                <div class="filter-container">
                    ...
                    <div class="filter-buttons">
                        ...
                        <a href="admin_dashboard_contact.php" class="clear-filter">Clear Filter</a>
                    </div>
                </div>
            </form>
