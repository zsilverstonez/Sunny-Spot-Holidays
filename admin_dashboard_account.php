                ...
                if ($valid) {
                    if ($action === 'insert') {
                        ...
                        if ($uploadPhoto) {
                            ...
                            // Declare variable types
                            $accountTable->bind_param("ssssssssi", $username, $password, $first_name, $last_name, $address, $phone, $mobile, $photo, $staffID);
                            // Execute getting accounts data
                            $accountTable->execute();
                            // Close getting accounts data 
                            $accountTable->close();
        ...
        <div class="user-details">
            ...
            <div class="new-user">
                <form method="POST" enctype="multipart/form-data"
                    ...
                    <div class="form-divider"><label>Password:</label><input type="text" name="password[]" required>
                    </div>
                    <div class="form-divider"><label>First Name:</label><input type="text" name="firstName[]"></div>
                    <div class="form-divider"><label>Last Name:</label><input type="text" name="lastName[]"></div>
                    <div class="form-divider"><label>Address:</label><input type="text" name="address[]"></div>
                    <div class="form-divider"><label>Phone:</label><input type="text" name="phone[]"></div>
            ...
            <div class="user-display" data-id="<?php echo $user['staffID']; ?>">
                <form method="POST" onsubmit="return confirm('Are you sure about updating this user?');"
                    ...
                    <div class="form-divider"><label>Photo: </label>
                        <div class="photo-container">
                            <img src="staffPhoto/<?php echo !empty($user['userPhoto']) ? htmlspecialchars($user['userPhoto']) : ""; ?>"
                                alt="Staff Photo" width="150px" height="100px">
                            <input type="file" name="userPhoto[]">
