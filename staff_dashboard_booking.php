...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    if (!isset($_POST['csrf_token']) || $_POST['csrf_token'] !== $_SESSION['csrf_token']) {
        ...
        // Reload bookings from database after updating
        $bookings = [];
        $result = $connect->query($query);
        // Get each data pair of rows
        while ($row = $result->fetch_assoc()) {
...
<head>
    ...
    <title>Sunny Spot Holidays- Staff Dashboard - Booking</title>
...
<body>
    <header>
        ...
        <nav>
            <ul>
                <li class="nav-booking"><a href="staff_dashboard_booking" class="active">Booking</a></li>
            ...
            <form method="GET" action="" class="filter-form">
                <div class="filter-container">
                    ...
                    <div class="filter-buttons">
                        ...
                        <a href="staff_dashboard_booking" class="clear-filter">Clear Filter</a>
                    </div>
                </div>
            </form>
